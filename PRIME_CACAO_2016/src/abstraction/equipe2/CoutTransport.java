...
public class CoutTransport {
	...
	public void setCouttransport(double couttransport, IProducteur p, CommandeProd commande) {
		this.couttransport=couttransport*this.distances.get(p)*commande.getCommandes();
	...
	public static void main(String[] args) {
		...
		CoutT.setCouttransport(couttransport,p1);
