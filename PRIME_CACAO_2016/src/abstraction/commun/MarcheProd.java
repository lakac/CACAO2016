...
public class MarcheProd implements Acteur{
	...
	public void ActualisationCours(){
		...
		this.getCoursCacao().setValeur(this,this.getCoursCacao().getValeur()*(1+(this.getQuantiteTotaleDemandee()-this.getQuantiteTotaleFournie())/(this.getQuantiteTotaleFournie())));
