...
public class Constante {
	 // voir avec le prof si ca peut marcher
	 public static int STEP_COURANT = Monde.LE_MONDE.getStep();
	 public static int STEP_PRECEDENT = Monde.LE_MONDE.getStep()-1;
	 public static int STEP_2 = Monde.LE_MONDE.getStep()-2;
	 public static int STEP_3 = Monde.LE_MONDE.getStep()-3;
